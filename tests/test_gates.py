...
`pingu/SKILL.md` claims "the gates are what make autonomy safe". Until now that
...
def test_every_phase_in_the_gate_table_has_a_declared_gate():
    """The table in pingu/SKILL.md and GATES are the same list written twice."""
...
def test_the_documented_split_of_checkable_versus_manual_still_holds():
    """README, MANUAL and pingu/SKILL.md all state this breakdown in prose. It
